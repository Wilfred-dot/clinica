  ...
  return (
    <PortalLayout>
      ...
      <div className="max-w-[960px] mx-auto px-6 py-8">
        ...
        {/* Próximas Consultas */}
        <div className="text-[11.5px] font-bold text-ink-3 uppercase tracking-[0.8px] mb-3.5">
          Próximas Consultas
        </div>
        <div className="grid grid-cols-[repeat(auto-fill,minmax(210px,1fr))] gap-3.5 mb-6">
          {consultas.length > 0 ? consultas.map(c => (
            ...
            <p className="text-[13px] text-ink-4 col-span-full">Nenhuma consulta agendada.</p>
          )}
        </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {notificacoes.length > 0 ? notificacoes.map(n => {
                ...
                <p className="text-[13px] text-ink-4">Sem notificações.</p>
              )}
            </div>
          </div>
