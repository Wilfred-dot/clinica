    ...
    <Shell>
      ...
      <div className="flex items-start justify-between gap-4 mb-7 flex-wrap">
        <div>
          ...
          <p className="text-[13px] text-[#6b8299] mt-1">Registar paciente na base de dados</p>
        </div>
        <button
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mb-2">
            ...
            />
            {fieldErrors.name && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.name}</p>}
          </div>
          <div className="mb-2">
            <label className="block text-[11.5px] font-semibold uppercase tracking-[0.6px] text-[#2e4358] mb-1.5">
              Data de nascimento
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#0c1a27] outline-none transition focus:border-[#007d74] focus:ring-[0_0_0_3px_rgba(0,125,116,0.1)]"
            />
            {fieldErrors.dataNascimento && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.dataNascimento}</p>}
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 mt-2">
          ...
          <div className="mb-2">
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#0c1a27] outline-none transition focus:border-[#007d74] focus:ring-[0_0_0_3px_rgba(0,125,116,0.1)]"
            />
            {fieldErrors.telefone && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.telefone}</p>}
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4 mt-2">
          <div className="mb-2">
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#0c1a27] outline-none transition focus:border-[#007d74] focus:ring-[0_0_0_3px_rgba(0,125,116,0.1)]"
            />
            {fieldErrors.email && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.email}</p>}
          </div>
          <div className="mb-2">
            <label className="block text-[11.5px] font-semibold uppercase tracking-[0.6px] text-[#2e4358] mb-1.5">
              Endereço
            ...
            <input
              ...
              className="w-full h-12 px-4 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#0c1a27] outline-none transition focus:border-[#007d74] focus:ring-[0_0_0_3px_rgba(0,125,116,0.1)]"
            />
            {fieldErrors.endereco && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.endereco}</p>}
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full h-12 px-4 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#0c1a27] outline-none transition focus:border-[#007d74] focus:ring-[0_0_0_3px_rgba(0,125,116,0.1)]"
          />
          {fieldErrors.password && <p className="text-xs text-[#b83232] mt-1">{fieldErrors.password}</p>}
        </div>
