  ...
  return (
    <Shell>
      <div className="flex items-start justify-between gap-4 mb-7 flex-wrap">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-1.5 rounded-[8px] border border-[#d6e0ea] bg-white px-4 py-2 text-[13.5px] font-bold text-ink-3 transition hover:bg-slate"
          onClick={() => router.back()}
        >
          ← Voltar
        </button>
        ...
        <div className="flex justify-between items-center gap-3 flex-wrap pt-5 mt-5 border-t border-[#ecf1f6]">
          <div className="flex gap-3">
            ...
            <button
              type="button"
              onClick={() => router.back()}
              className="inline-flex items-center gap-1.5 rounded-[8px] border border-[#d6e0ea] bg-white px-5 h-12 text-sm font-bold text-ink-3 transition hover:bg-slate"
            >
              Cancelar
            </button>
          </div>
