  ...
  return (
    <Shell>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        {/* Coluna Esquerda - Tabela de Consultas do Dia - COM h-fit */}
        <div className="bg-[var(--white)] rounded-[12px] border border-[var(--border2)] shadow-[0_2px_4px_rgba(16,42,107,.03)] overflow-hidden h-fit">
