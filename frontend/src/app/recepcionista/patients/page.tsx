  ...
  return (
    <Shell>
      ...
      <div className="flex items-start justify-between gap-4 mb-7 flex-wrap">
        <div>
          <h1 className="text-[22px] font-bold text-[#102A6B] tracking-[-0.3px]">Pacientes</h1>
      ...
      <div className="bg-white rounded-[12px] border border-[#ecf1f6] shadow-[0_1px_3px_rgba(12,26,39,.05)] overflow-hidden">
        <div className="flex items-center justify-between gap-3 p-[16px_22px] border-b border-[#ecf1f6] flex-wrap">
          <h3 className="text-[14.5px] font-bold text-[#102A6B]">Lista de Pacientes</h3>
          <div className="relative min-w-[200px]">
            ...
            <input
              ...
              className="w-full h-10 pl-8 pr-3 rounded-[8px] border border-[#d6e0ea] bg-white text-sm text-[#102A6B] outline-none transition focus:border-mmq-orange"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="bg-slate text-[11px] font-bold text-ink-3 uppercase tracking-[0.7px] p-[10px_18px] text-left border-b border-[#ecf1f6]">Nome</th>
                <th className="bg-slate text-[11px] font-bold text-ink-3 uppercase tracking-[0.7px] p-[10px_18px] text-left border-b border-[#ecf1f6]">Contacto</th>
                <th className="bg-slate text-[11px] font-bold text-ink-3 uppercase tracking-[0.7px] p-[10px_18px] text-left border-b border-[#ecf1f6]">Último Atendimento</th>
                ...
                <th className="bg-slate text-[11px] font-bold text-ink-3 uppercase tracking-[0.7px] p-[10px_18px] text-left border-b border-[#ecf1f6]">Acções</th>
              </tr>
            </thead>
            <tbody>
                  ...
                  <tr key={patient.id} className="border-b border-[#ecf1f6] last:border-b-0 hover:bg-[#f6fafe] transition">
                    ...
                    <td className="p-[12px_18px]">
                      <Link
                        ...
                        className="inline-flex items-center rounded-[6px] px-3 py-1.5 text-xs font-semibold border border-[#d6e0ea] bg-white text-ink-2 transition hover:bg-slate"
                      >
                        Histórico
                      </Link>
                    </td>
